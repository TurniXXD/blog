...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), StackedElements = ({ count, className }) => {
  let elements = [];
  ...
  (0, import_react7.useEffect)(() => {
    let matrixCols = [], colIndex = 0, level = 5;
    setInterval(() => {
      ...
      bipolarRandomState() ? level !== 15 && (level += 1) : level !== 0 && (level -= 1), colIndex < 30 ? colIndex++ : colIndex = 0;
    }, 350);
  }, []);
  for (let i = 1; i <= 30; i++)
    cols.push(/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
      id: `matrix-col-${i}`,
...
var tailwind_default = "/build/_assets/tailwind-AOIYQ32A.css";

// app/styles/global.css
var global_default = "/build/_assets/global-5SINURGG.css";
